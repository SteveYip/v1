  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className=" bg-white">
            ...
            <ul className="flex items-center">
              ...
              <li>
                <a
                  ...
                  href="/resume/CV-Steve.pdf" target="_blank" rel="noopener noreferrer"
                >
                  Resume
                </a>
              </li>
        ...
        <section id="about" className="bg-[#e5e5e5] p-[12px]">
          <div id="about__container" className="w-7/12 m-auto">
            <div id="about-heading" className="flex justify-center mb-10">
              <h3 className="text-3xl py-3 dark:text-white text-center ">About Me
